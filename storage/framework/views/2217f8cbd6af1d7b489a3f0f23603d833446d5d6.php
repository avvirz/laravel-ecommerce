<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
                <a href="<?php echo e(url('offer')); ?>" class="nav-link">
...
<?php /**PATH C:\Users\rajputkishor1973\Desktop\Thewayshop\resources\views/partials/admin/sidebar.blade.php ENDPATH**/ ?>