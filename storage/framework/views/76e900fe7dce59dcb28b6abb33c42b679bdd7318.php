                                    ...
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $categorie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr role="row">
                                            ...
                                            <td class="text-center px-4">
                                                ...
                                                <button class="btn btn-primary  text-center"><a
                                                        href="<?php echo e(route('category.edit', $categorie->id)); ?>"
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/uLaravel/laravel-auth/resources/views/pages/admin/category/index.blade.php ENDPATH**/ ?>