<?php $__env->startSection('content'); ?>
    ...
    <div class="container mb-4">
        ...
        <div class="card">
            ...
            <div class="card-header col-md-12">
                <a href="<?php echo e(route('email')); ?>" class="btn btn-success">Send Mail</a>
            </div>
            <div class="card-body">
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/uLaravel/Thewayshop/resources/views/pages/admin/email.blade.php ENDPATH**/ ?>