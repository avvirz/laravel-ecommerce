...
<head>
    <?php $__env->startSection('template_linked_fonts'); ?>
            ...
            <div class="categories-shop">
                <div class="container">
                    <div class="row">
                        ...
                        <?php if($cat->category_id == NULL): ?>
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="shop-cat-box">
                                <img class="img-fluid" src="imagesuser/t-shirts-img.jpg" alt="" />
                                <a class="btn hvr-hover" href="products/<?php echo e($cat->id); ?>"><?php echo e($cat->name); ?></a>
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="special-menu text-center">
                                <div class="button-group filter-button-group">
                                    <button class="active" data-filter=".best-seller">All</button>
                    ...
                    <div class="row special-list">
                        ...
                        <div class="col-lg-3 col-md-6 special-grid best-seller">
                            <div class="products-single fix">
                                ...
                                <div class="why-text">
                                    <h4><a href="productDetails/<?php echo e($product->id); ?>"><?php echo e($product->product_name); ?></a></h4>
                                    <h6><?php echo e($product->description); ?></h6>
                                    <h5><span class="fa fa-rupee"></span><span style="color:#d33b33;"> <?php echo e($product->price); ?></span></h5>
                                </div>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        
                        <?php $__currentLoopData = $productLimit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proLimit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-3 col-md-6 special-grid top-featured" style="display: none;">
                            <div class="products-single fix">
                                <div class="box-img-hover">
                                    <div class="type-lb">
                                        <p class="new">New</p>
                                    </div>
                                    <img src="uploads/<?php echo e($proLimit->image); ?>" class="img-fluid" alt="Image">
                                    <div class="mask-icon">
                                        <ul>
                                            <li><a href="#" data-toggle="tooltip" data-placement="right" title="View"><i class="fas fa-eye"></i></a></li>
                                            <li><a href="#" data-toggle="tooltip" data-placement="right" title="Compare"><i class="fas fa-sync-alt"></i></a></li>
                                ...
                                <div class="why-text">
                                    <h4><a href="productDetails/<?php echo e($proLimit->id); ?>"><?php echo e($proLimit->product_name); ?></a></h4>
                                    <h6><?php echo e($proLimit->description); ?></h6>
                                    <h5><span class="fa fa-rupee"></span><span style="color:#d33b33;"> <?php echo e($proLimit->price); ?></span></h5>
                                </div>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/uLaravel/laravel-auth/resources/views/welcome.blade.php ENDPATH**/ ?>