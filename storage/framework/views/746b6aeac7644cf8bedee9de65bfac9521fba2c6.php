                            ...
                            <div class="row">
                                <div class="col-md-12"> 
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control<?php echo e($errors->has('long_description') ? ' is-invalid' : ''); ?>" name="long_description" rows="3" cols="12"  autofocus><?php echo e(old('long_description')); ?></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\14thfeb_laravel-auth\laravel-auth\resources\views/pages/admin/product/add.blade.php ENDPATH**/ ?>