                                            ...
                                            <td>
                                                <div class="text-center ">
                                                    <a href="<?php echo e(route('blogs.edit', $blog->id)); ?>"
                                                        class="btn btn-primary my-2 text-right"><i
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/uLaravel/laravel-auth/resources/views/pages/admin/blogs/index.blade.php ENDPATH**/ ?>