                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="shop-cat-box">
                                <img class="img-fluid" src="imagesuser/mencat.png" alt="" />
                        ...
                        <div class="col-lg-12">
                            <div class="special-menu text-center">
                                <div class="button-group filter-button-group">
                                    <button class="active" id="productsAllBtn">All</button>
                    ...
                    <div class="row special-list">
                        ...
                        <div class="col-lg-3 col-md-6 special-grid best-seller">
                            <div class="products-single fix">
                                ...
                                <div class="why-text">
                                    <h4>
                                        <a href="<?php echo e(route('product.detail',$product->id)); ?>"><?php echo e($product->product_name); ?></a>
                                    </h4>
                                    <p><?php echo e($product->description); ?> </p>
                                   <h5><del><span class="fa fa-inr"></span> <?php echo e($product->price); ?></span> </del><?php echo e($product->discount_price); ?></h5>
                                </div>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\14thfeb_laravel-auth\laravel-auth\resources\views/welcome.blade.php ENDPATH**/ ?>