<?php $__env->startSection('template_title'); ?>
    <?php echo trans('usersmanagement.showing-user-deleted'); ?> <?php echo e($user->name); ?>
                ...
                <div class="card">
                    ...
                    <div class="card-header bg-danger text-white">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <?php echo trans('usersmanagement.usersDeletedPanelTitle'); ?>

                            <div class="float-right">
                                <a href="/users/deleted/" class="btn btn-light btn-sm float-right" data-toggle="tooltip" data-placement="left" title="<?php echo e(trans('usersmanagement.usersBackDelBtn')); ?>">
                                    <!-- <i class="fa fa-fw fa-mail-reply" aria-hidden="true"></i> -->
                                    <!-- <span class="sr-only"> -->
                                            <?php echo trans('usersmanagement.usersBackDelBtn'); ?>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12 col-md-12 text-center">
                                <img src="<?php if($user->profile && $user->profile->avatar_status == 1): ?> <?php echo e($user->profile->avatar); ?> <?php else: ?> <?php echo e(Gravatar::get($user->email)); ?> <?php endif; ?>" alt="<?php echo e($user->name); ?>" class="rounded-circle center-block mb-3 mt-4 user-image" height="200" width="250">
                            </div>
                            <div class="col-sm-12 col-md-12">
                                ...
                                <div class="text-center text-left-tablet mb-4">
                                    <?php echo Form::model($user, array('action' => array('SoftDeletesController@update', $user->id), 'method' => 'PUT', 'class' => 'form-inline')); ?>
                                        ...
                                        <?php echo Form::button('<i class="fas fa-undo-alt" aria-hidden="true"></i> Restore User', array('class' => 'btn btn-success btn-block btn-sm mt-1 mb-1', 'type' => 'submit', 'data-toggle' => 'tooltip', 'title' => 'Restore User')); ?>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/uLaravel/laravel-auth/resources/views/usersmanagement/show-deleted-user.blade.php ENDPATH**/ ?>