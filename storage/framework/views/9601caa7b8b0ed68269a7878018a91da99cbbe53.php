            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                ...
                <?php $__currentLoopData = $dynamicData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="right-phone-box mt-2">
                        <p>Call US : <a href="tel:<?php echo e($data->phone); ?>"> <?php echo e($data->phone); ?></a></p>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <div class="our-link">
                    <ul>
                        <?php if(auth()->guard()->check()): ?>
                            <li class="mt-3"><a href="<?php echo e(url('profile/' . Auth::user()->name)); ?>"><span
                                        class="user-color">Welcome</span> <?php echo e(Auth::user()->name); ?></a></li>
                        <?php else: ?>
        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/">
                    <?php $__currentLoopData = $dynamicData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $logo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <img src="<?php echo e(asset('imagesuser/' . $logo->logo)); ?>" class="logo" alt="" height="100"
                            width="200">
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                    <li class="nav-item <?php echo e(Request::is('/')?'active':''); ?>"><a class="nav-link" href="/">Home</a></li>
                                    ...
                                    <div class="col-menu col-md-3">
                                        <ul>
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php echo $__env->make('partials.categories', [
                                                    'category' => $category,
                    ...
                    <li class="dropdown <?php echo e(Request::is('cart')||Request::is('wishlist')||Request::is('OrderDetails')?'active':''); ?>">
                            ...
                            <?php if(Auth::User()->profile && Auth::user()->profile->avatar_status == 1): ?>
                                <a class="nav-link dropdown-toggle arrow" href="#" role="button" data-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false" v-pre><img
                                        src="<?php echo e(Auth::user()->profile->avatar); ?>" height='30px' width="30px" alt=""
                                        class="rounded-circle user-avatar-nav img-border"><span>
                                        <?php echo e(Auth::user()->name); ?></span></a>
                            <?php else: ?>
                                <a class="nav-link dropdown-toggle arrow" href="#" role="button" data-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false" v-pre><img
                                        src="<?php echo e(asset('dist/img/avtar.png')); ?>" height='30px' width="30px" alt=""
                                        class="rounded-circle user-avatar-nav img-border"><span>
                                        <?php echo e(Auth::user()->name); ?></span></a>
                            <?php endif; ?>
                            <ul class="dropdown-menu">
                    ...
                    <ul class="cart-list">
                        <?php $__currentLoopData = $cartData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cartData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                ...
                                ?>
                                <a href="#" class="photo"><img src="<?php echo e(asset('uploads/' . $image[0])); ?>"
                                        height="60px" width="36px" class="cart-thumb" alt="" /></a>
                                <h6><a href="<?php echo e(route('cart.index')); ?>"><?php echo e($cartData->product->product_name); ?> </a>
                                </h6>
                                <p>Qty - <?php echo e($cartData->quantity); ?> <span class="price"> <strong> | </strong>
                                        ₹<?php echo e($cartData->total); ?></span></p>
                            </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <li class="total">
                            <a href="<?php echo e(route('cart.index')); ?>" class="btn btn-default btn-sm hvr-hover btn-cart">VIEW
                                CART</a>
                        </li>
                    </ul>
                </li>
...
<?php /**PATH /var/www/html/14-03-2022/abhi 14-03/Thewayshop/resources/views/partials/header.blade.php ENDPATH**/ ?>