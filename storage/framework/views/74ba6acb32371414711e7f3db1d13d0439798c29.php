                                                        ...
                                                        <div id="avatar_container">
                                                            <div class="collapseOne card-collapse collapse <?php if($user->profile->avatar_status == 0): ?> show <?php endif; ?>">
                                                                <div class="card-body text-center">
                                                                    <img src="<?php echo e(Gravatar::get($user->email)); ?>" alt="<?php echo e($user->name); ?>" class="rounded-circle user-avatar" height="200" width="250">
                                                                </div>
                                                            </div>
                                                            <div class="collapseTwo card-collapse collapse <?php if($user->profile->avatar_status == 1): ?> show <?php endif; ?>">
                                                                <div class="card-body text-center">
                                                                    ...
                                                                    <?php echo Form::open(array('route' => 'avatar.upload', 'method' => 'POST', 'name' => 'avatarDropzone','id' => 'avatarDropzone', 'class' => 'form single-dropzone dropzone single', 'files' => true)); ?>
                                                                        ...
                                                                        <img id="user_selected_avatar" class="rounded-circle" src="<?php if($user->profile->avatar != NULL): ?> <?php echo e($user->profile->avatar); ?> <?php endif; ?>" alt="<?php echo e($user->name); ?>" height="200" width="250">
                                                                    <?php echo Form::close(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/uLaravel/laravel-auth/resources/views/profiles/edit.blade.php ENDPATH**/ ?>