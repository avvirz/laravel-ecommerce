                  ...
                  <?php if(Auth::User()->profile && Auth::user()->profile->avatar_status == 1): ?>
                      <a class="nav-link dropdown-toggle arrow" href="#" role="button" data-toggle="dropdown"
                          aria-haspopup="true" aria-expanded="false" v-pre><img src="<?php echo e(Auth::user()->profile->avatar); ?>"
                              height='30px' width="30px" style="border-radius: 50%" alt=""
                              class="rounded-circle user-avatar-nav"><span> <?php echo e(Auth::user()->name); ?></span></a>
                  <?php else: ?>
                      <a class="nav-link dropdown-toggle arrow" href="#" role="button" data-toggle="dropdown"
...
<?php /**PATH /var/www/html/uLaravel/laravel-auth/resources/views/partials/admin/navbar.blade.php ENDPATH**/ ?>