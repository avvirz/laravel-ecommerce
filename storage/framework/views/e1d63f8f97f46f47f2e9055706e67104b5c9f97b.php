   ...
   <!-- Start All Title Box -->
                        ...
                        <div class="row product-categorie-box">
                            <div class="tab-content">
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                ...
                                                <div class="why-text">
                                                    ...
                                                    <h5><span class="fa fa-rupee"></span> <?php echo e($product->price); ?></h5>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="list-view">
                                    <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $products): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                                <div class="why-text full-width">
                                                    ...
                                                    <h5> <del><span class="fa fa-rupee"></span> <?php echo e($products->price); ?></del><span class="fa fa-rupee"></span> <?php echo e($products->discount_price); ?></h5>
                                                    <p><?php echo e($products->long_description); ?></p>
    ...
    <div class="instagram-box">
        <div class="main-instagram owl-carousel owl-theme">
            ...
            <div class="item">
                <div class="ins-inner-box">
                    <img src="imagesuser/instagram-img-06.jpg" alt="" />
                    <div class="hov-in">
                        <a href="#"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
            ...
            <div class="item">
                <div class="ins-inner-box">
                    <img src="imagesuser/instagram-img-07.jpg" alt="" />
                    <div class="hov-in">
                        <a href="#"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/uLaravel/laravel-auth/resources/views/products.blade.php ENDPATH**/ ?>