                                ...
                                <?php $__currentLoopData = $wishlist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wishlistData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr id="wishArea<?php echo e($wishlistData->id); ?>">
                                        <td class="thumbnail-img">
                                            ...
                                            ?>
                                                    src="<?php echo e(asset('uploads/' .  $image[0])); ?>" alt=""
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/14-03-2022/abhi 14-03/Thewayshop/resources/views/wishlist.blade.php ENDPATH**/ ?>