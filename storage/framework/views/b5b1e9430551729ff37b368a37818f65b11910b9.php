    ...
    <div class="cart-box-main">
        <div class="container">
                                        ...
                                        <tr class="cartArea" id="cartArea<?php echo e($cartData->id); ?>">
                                            ...
                                            <td class="thumbnail-img">
                                                <a href="">
                                                    ...
                                                    ?>
                                                    <img class="img-fluid" src="<?php echo e(asset('uploads/' . $image[0])); ?>"
                                                        alt="" />
                                                </a>
                                            </td>
                                            <td class="name-pr">
                                            ...
                                            <td class="price-pr">
                                                <p><?php echo e($cartData->discount_price); ?>
                                                    ...
                                                    <input type="hidden" value="<?php echo e($cartData->discount_price); ?>"
                                            ...
                                            <td class="quantity-box">
                                                <input type="number" id="qty<?php echo $i; ?>" name="productQty"
                                                    onchange="subTotal()" min="1" max="<?php echo e($cartData->available_stock); ?>"
                                                    step="1" class="c-input-text qty text qty"
                                                    value="<?php echo e($cartData->quantity); ?>">
                                            </td>
                                            <td>
                                                <p class="totalSum"></p>
                                            </td>
                                            ...
                                            <td class="remove-pr">
                                                <li style="border:none;">
                                                    <a href="javascript:void(0)" class="btn btn-danger" id="removeCartItem"
                                                        data-removeid=<?php echo e($cartData->id); ?>>
            ...
            <div class="row my-5">
                ...
                <div class="col-12 d-flex shopping-box"><a href="checkout.html" class="ml-auto btn hvr-hover">Checkout
                        All</a> </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/uLaravel/Thewayshop/resources/views/cart/index.blade.php ENDPATH**/ ?>