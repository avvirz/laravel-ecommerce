...
<?php $__env->startSection('content'); ?>
    ...
    <div class="cart-box-main">
        <div class="container-fluid">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $orderData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orderDetails): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="">
                                            <p> <?php echo e($orderDetails->quantity); ?> </p>
                                        </td>
                                        <td class="">
                                        ...
                                        <td>
                                            <a
                                                href="<?php echo e(route('pdfView', "$orderDetails->id", ['download' => 'pdf'])); ?>">Download</a>
            ...
            <div class="links"><?php echo e($orderData->links()); ?></div>
        </div>
    </div>
    <!-- End Cart -->
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/14-03-2022/abhi 14-03/Thewayshop/resources/views/OrderDetails.blade.php ENDPATH**/ ?>