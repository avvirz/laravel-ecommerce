                            ...
                            <div class="row">
                                <div class="col-md-12"> 
                                    <div class="form-group">
                                        ...
                                        <input type="radio" class="form-control1" name="status" value="pending" <?php if($orders->order_status == "pending"): ?> checked <?php endif; ?> >
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/uLaravel/laravel-auth/resources/views/pages/admin/order/edit.blade.php ENDPATH**/ ?>