                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <img src="@if ($user->profile->avatar_status == 1) {{ $user->profile->avatar }} @else {{ Gravatar::get($user->email) }} @endif" height="80  " width="80" alt="{{ $user->name }}" class="rounded-circle user-avatar">
                        </div>
                        <dl class="user-info">
                            <dt>
